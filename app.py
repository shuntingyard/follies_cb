...
def start():
    ...
    print(f"App Callback URL set to {app_callback_url}")
...
def callback():
    ...
    print(f"SUCCESS, oT: {oauth_token}, otS: {oauth_token_secret}")
    ...
    print(f"TO STORE, rOt: {real_oauth_token}, rotS: {real_oauth_token_secret}")
